...
var wasmBinaryFile = 'perlin-wasm.wasm';
...
var real__generatePerlinNoise = asm["generatePerlinNoise"];
asm["generatePerlinNoise"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__generatePerlinNoise.apply(null, arguments);
};
...
var _generatePerlinNoise = Module["_generatePerlinNoise"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["generatePerlinNoise"].apply(null, arguments)
};
